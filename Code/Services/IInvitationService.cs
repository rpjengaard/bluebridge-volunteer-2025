...
public interface IInvitationService
{
    ...
    Task<AcceptInvitationResult> AcceptInvitationAsync(string token, IEnumerable<int> crewIds, DateTime birthdate, string password, string portalUrl, string? memberWish = null, IEnumerable<string>? selectedTimeslots = null);
...
public class AcceptInvitationResult
{
    ...
    public IEnumerable<string>? SelectedTimeslots { get; set; }
}
